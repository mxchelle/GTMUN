...
function wp_bootstrap_custom_admin_footer() {
	echo '<span id="footer-thankyou">Developed by <a href="http://michellepartogi.com" target="_blank">Michelle Partogi</a>. Built off <a href="http://320press.com" target="_blank">320press</a></span>.';
}
...
function wp_bootstrap_register_sidebars() {
    ...
    register_sidebar(array(
      'id' => 'hero',
      'name' => 'Frontpage Hero',
      'before_widget' => '<div class="hero-text widget col-md-6 col-md-offset-3 %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h1>',
      'after_title' => '</h1>',
    ));
    ...
    register_sidebar(array(
      'id' => 'homepage',
      'name' => 'Homepage: Counter Bar',
      'description' => 'Used on homepage to show counter till date.',
      'before_widget' => '',
      'after_widget' => '',
      'before_title' => '<h4 class="widgettitle">',
      'after_title' => '</h4>',
    ...
    register_sidebar(array(
      ...
      'description' => 'Used on homepage page template.',
      'before_widget' => '<div id="%1$s" class="widget %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h4 class="widgettitle">',
      'after_title' => '</h4>',
    ...
    register_sidebar(array(
      'id' => 'quote',
      'name' => 'Homepage: Quote',
      'description' => 'Quote used on homepage page to divide page.',
      'before_widget' => '<div id="%1$s" class="widget %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h4 class="widgettitle">',
      'after_title' => '</h4>',
...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
        ...
        // For child themes
        wp_register_style( 'print', get_stylesheet_directory_uri() . '/library/css/print.css', array(), '1.0', 'print' );
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script( 'bootstrap', 
     ...
     wp_register_script( 'classie', 
      get_template_directory_uri() . '/library/js/classie.js', 
      array('jquery'), 
      '1.2' );
